...
@section('content')
    ...
    <section class="breadcrumb-area wa-p-relative" >
        <div class="breadcrumb-bg-img wa-fix wa-img-cover">
            <img class="wa-parallax-img" title="breadcrumb-faqs" src="{{ url('frontend/assets/img/breadcrumb/breadcrumb-faqs.png') }}" alt="breadcrumb-faqs">
        </div>
                    ...
                    <div class="title-img">
                        ...
                        <div class="bs-faqs-6-img">
                            <i class="fa-solid fa-building"></i>
                                <img title="faq-img" src="{{ url('frontend/assets/img/faq/faq-img.png') }}" alt="faq-img">
