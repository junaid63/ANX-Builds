...
@section('title')
Garden Granny Annexe UK Contact | ANX Builds Today
@endsection
        ...
        <div class="bs-contact-6-wrap">
            ...
            <div class="bs-contact-6-content">
                ...
                <form id="contact-form" class="bs-form-1 bs-career-single-form">
                    ...
                    <div class="bs-form-1-item">
                        <div class="g-recaptcha" id="g-recaptcha-response" data-sitekey="6LeT9FMsAAAAACGw3-3zcKuEuy4-6RqJLQWlmuaw">
                        </div>  
                    </div>
       ...
       $(function () {
            $('#ContactSubmit').on('click', function () {
                grecaptcha.ready(function () {
                    grecaptcha.execute('6LeT9FMsAAAAACGw3-3zcKuEuy4-6RqJLQWlmuaw', {
                        action: 'contact_form'
                    }).then(function (token) {
