    ...
    <div class="container bs-container-1">
        <div class="bs-office-1-wrap">
            ...
            <div class="bs-office-1-left">
                ...
                <div class="bs-about-1-content mb-lg-5">
                ...
                <div class="bs-office-1-item">
                    ...
                    <div class="bs-office-1-card wa-clip-left-right">
                        ...
                        <p class="bs-p-1 disc">Pods, offices & compact modular spaces. </p>
                    ...
                    <div class="bs-office-1-card wa-clip-left-right">
                        ...
                        <p class="bs-p-1 disc">Home extensions & annex solutions.</p>
                    ...
                    <div class="bs-office-1-card wa-clip-left-right">
                        ...
                        <p class="bs-p-1 disc">Steel-frame builds & larger modular structures.</p>
                ...
                <div class="bs-about-1-content my-lg-5">
                    <p class="bs-p-1 disc wa-split-y wa-capitalize">
                        We support homeowners nationwide with dependable service and efficient project timelines.
                    </p>
                </div>
            </div>
